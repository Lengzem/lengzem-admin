  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    ...
    <SettingsLayout>
      <div class="max-w-6xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden border border-white/20 dark:border-gray-700/30">
          ...
          <div class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-8 text-white relative">
            ...
            <div class="relative z-10 flex flex-col md:flex-row items-center gap-8">
              ...
              <div class="relative group">
                <div class="absolute -inset-1 bg-gradient-to-r from-cyan-400 to-purple-600 rounded-full blur opacity-75 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div class="relative h-32 w-32 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-5xl font-bold text-indigo-600 dark:text-indigo-300 shadow-xl border-4 border-white/30">
              ...
              <div class="text-center md:text-left">
                ...
                <div class="mt-4 flex flex-wrap justify-center md:justify-start gap-3">
                  <span class="px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full text-sm font-medium flex items-center">
                  ...
                  <span v-if="user.role" class="px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full text-sm font-medium">
                    {{ user.role }}
                  </span>
                </div>
              </div>
          ...
          <div v-else-if="error" class="p-8">
            <div class="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/30 dark:to-red-800/20 p-6 rounded-xl border border-red-200 dark:border-red-700/50">
              <div class="flex items-start">
                <div class="flex-shrink-0">
                  <svg class="h-10 w-10 text-red-500 dark:text-red-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="ml-4">
                  ...
                  <div class="mt-4">
                    <button @click="retryLoad" class="text-sm font-medium text-red-700 dark:text-red-200 hover:text-red-600 dark:hover:text-red-100">
          ...
          <!-- Profile Content -->
          <div v-else class="grid grid-cols-1 lg:grid-cols-3 divide-y lg:divide-y-0 lg:divide-x divide-gray-200 dark:divide-gray-700/50">
            ...
            <div class="p-8 lg:col-span-2">
              <div class="flex justify-between items-center mb-6">
                ...
                <button @click="openEditPro" class="flex items-center text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 transition-colors">
              ...
              <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div class="bg-gray-50 dark:bg-gray-800/50 p-5 rounded-xl border border-gray-100 dark:border-gray-700/50">
                    <h3 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Contact</h3>
                  ...
                  <div class="bg-gray-50 dark:bg-gray-800/50 p-5 rounded-xl border border-gray-100 dark:border-gray-700/50">
                    <h3 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Account Details</h3>
                    <p class="text-gray-800 dark:text-gray-200 font-medium flex items-center">
                      <svg class="w-5 h-5 text-gray-400 dark:text-gray-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Bio Section -->
                <div class="bg-gray-50 dark:bg-gray-800/50 p-5 rounded-xl border border-gray-100 dark:border-gray-700/50">
                  <h3 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">UID</h3>
                  ...
                  <div v-else class="text-center py-4">
                    ...
                    <button @click="openEditPro" class="mt-2 text-sm text-indigo-600 dark:text-indigo-400 hover:underline">Add a id</button>
                  </div>
                </div>

                <!-- Bio Section -->
                <div class="bg-gray-50 dark:bg-gray-800/50 p-5 rounded-xl border border-gray-100 dark:border-gray-700/50">
                  <h3 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Biography</h3>
                  ...
                  <div v-else class="text-center py-4">
                    ...
                    <button @click="openEditPro" class="mt-2 text-sm text-indigo-600 dark:text-indigo-400 hover:underline">Add a bio</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="p-8 bg-gray-50/50 dark:bg-gray-800/30">
              ...
              <div class="space-y-4">
                <button @click="openEditPro" class="w-full flex items-center justify-between p-4 bg-white dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg border border-gray-200 dark:border-gray-600 transition-colors">
...
const user = ref<{ name: string, email: string, phone?: string, id?: string, created_at: string, role: string }>({ name: '', email: '', phone: '', id: '', created_at: '', role: '' });
