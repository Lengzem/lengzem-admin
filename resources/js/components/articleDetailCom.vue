        ...
        >
          ...
          <div class="p-6 sm:p-8 overflow-y-auto max-h-[calc(90vh-130px)] custom-scrollbar">
            ...
            <div v-else-if="error" class="text-center py-10">
              ...
              <button @click="fetchArticleDetails" class="mt-4 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors">
                Retry
              </button>
            </div>
            ...
            >
              <div v-if="article" class="space-y-6">
                ...
                <div class="flex flex-wrap gap-2 mb-4">
                  <span class="px-3 py-1 text-xs font-medium rounded-full bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-300">
                ...
                >
                  <div v-if="article.cover_image_url" class="my-6">
                    <img :src="article.cover_image_url" alt="Cover image" class="rounded-lg shadow-md w-full object-cover max-h-96 transition-all duration-300">
                  </div>
                </transition>
            ...
            <div class="p-6 sm:p-8 overflow-y-auto custom-scrollbar flex-grow">
                ...
                <div v-else-if="article" class="space-y-6">
                  <!-- ... all your detailed article content ... -->
                </div>
...
<script setup>
// The <script> block does not need any changes for this animation enhancement.
// Your existing logic for fetching data and managing state is correct.
